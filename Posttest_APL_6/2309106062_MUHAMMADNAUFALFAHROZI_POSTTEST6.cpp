    ...
    do {
        ...
        switch (menu) {
            case 1: {
                ...
                do {
                    tampilkanReview(jml, series);
                    cout << "\n[1] Urutkan berdasarkan nama (descending)\n";
                    ...
                    switch (submenu) {
                        case 1:
                            urutNamaDesc(jml, series);
                            tampilkanReview(jml, series);
                            break;
                        case 2:
                            urutTahunAsc(jml, series);
                            tampilkanReview(jml, series);
                            break;
                        case 3:
                            urutRatingDesc(jml, series);
                            tampilkanReview(jml, series);
                            break;
                        case 4:
                            cariJudulNama(jml, series);
                            break;
                        case 5:
                            cariTahun(jml, series);
                            break;
                        case 0:
                            cout << "Anda memilih untuk kembali ke menu utama.\n";
                            break;
                        default:
